...
from nat_base.modules import RelativeSelfAttention


class RelationBasedRPAttention(RelativeSelfAttention):
    ...
    def forward(
        ...
        # compute context weight [batch_size * num_head, seq_len, seq_len]
        ...
        relative_positions_matrix: torch.Tensor = kwargs['dependency_mat']
